    ...
    <div className="flex justify-between p-2 md:mx-6 relative" >
      ...
      <NavButton title="Cart" customFunc={()=> handleClick('cart') }
       ...
       <TooltipComponent content="Profile" position="BottomCenter" >
          <div className="flex items-center p-1 cursor-pointer gap-2 hover:bg-light-gray rounded-lg" >
            <img src={avatar} alt="avatar" className="h-8 w-8 rounded-full " />
            <p>
              <span className="text-gray-400 text-14" >Hi,</span> {' '}
              <span className="text-gray-400 text-bold ml-1 text-14" >Micheal</span>
            </p>
